...
namespace JEngine
{
	...
	void BitMap::DynamicDrawBitblt(int x, int y, float spx, float spy)
	{
		AdjustAnchorPoint(x, y);
		TransparentBlt(ResoucesManager::GetInstance()->GetBackDC(), x, y, m_size.cx*spx, m_size.cy*spy, m_hMemDC, 0, 0, m_size.cx*spx, m_size.cy*spy, RGB(255, 0, 255));
	}
