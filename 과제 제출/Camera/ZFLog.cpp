...
void ZFLog::CreateLogWindow()
{
	...
	wc.lpszClassName	= TEXT("ZLogWindow");
	...
	m_hwnd = CreateWindow( TEXT("ZLogWindow"), ZF_LOG_WINDOW_TITLE, WS_POPUP | WS_CAPTION, x, y, cx, cy, NULL, NULL, GetModuleHandle( NULL ), NULL );
	GetClientRect( m_hwnd, &rc );
	m_hwndList = CreateWindow( TEXT("LISTBOX"), TEXT(""), WS_CHILD | WS_VSCROLL, 0, 0, rc.right, rc.bottom, m_hwnd, NULL, GetModuleHandle( NULL ), NULL );
